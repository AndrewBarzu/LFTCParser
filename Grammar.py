...
class Grammar:
    def __init__(self, N: Set[str], Sigma: Set[str], P: Dict[Tuple[str], Set[Tuple[str]]], S: str):
        self.N = N
        self.Sigma = Sigma
        self.P = P
        self.S = S
    ...
    def getTerminalsString(self) -> str:
        return reduce(lambda x, y: x + ", " + y, self.Sigma, "")
    ...
    def getProductionsString(self) -> str:
        ...
        return reduce(lambda x, y: x + "\n" + y, productionsAsStrings, "")

    def getProds(self, nonTerminal: Tuple[str]) -> Set[Tuple[str]]:
